...
function onOpen() {
  ...
  ui.createMenu("📊 509 Dashboard")
    ...
    .addSubMenu(ui.createMenu("🔒 Security & Audit")
      .addItem("🔐 Configure RBAC Roles", "configureRBAC")
      .addItem("📋 View Audit Log", "viewAuditLog")
      .addItem("📊 Generate Audit Report", "showAuditReportDialog")
      .addItem("🚨 Check Suspicious Activity", "detectSuspiciousActivity")
      .addItem("⚙️ Setup Activity Monitoring", "setupSuspiciousActivityMonitoring")
      .addSeparator()
      .addItem("🗄️ Enforce Data Retention", "enforceDataRetention"))
    .addSeparator()
    .addSubMenu(ui.createMenu("💾 Backup & Performance")
      .addItem("💾 Create Backup Now", "createAutomatedBackup")
      .addItem("⚙️ Configure Backup Folder", "configureBackupFolder")
      .addItem("🔄 Setup Daily Backups", "setupDailyBackups")
    ...
    .addSubMenu(ui.createMenu("⚙️ Admin")
      ...
      .addSeparator()
      .addItem("🔧 Setup Audit & Security", "setupAuditAndSecurity"))
    .addSeparator()
